...
import { updatePairDayData, updatePairHourData, updateAstraDayData, updateTokenDayData } from "./dayUpdates";
import {
  findEthPerToken,
  getETHPriceInUSD,
...
export function handleMint(event: Mint): void {
  ...
  astra.totalTransactions = astra.totalTransactions.plus(ONE_BI);
...
export function handleSwap(event: Swap): void {
  ...
  astra.totalVolumeETH = astra.totalVolumeETH.plus(trackedAmountBNB);
  ...
  astraDayData.dailyVolumeETH = astraDayData.dailyVolumeETH.plus(trackedAmountBNB);

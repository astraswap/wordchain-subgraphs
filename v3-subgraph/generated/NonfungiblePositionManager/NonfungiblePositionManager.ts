...
export class AstraV3MintCallbackCall extends ethereum.Call {
  get inputs(): AstraV3MintCallbackCall__Inputs {
    return new AstraV3MintCallbackCall__Inputs(this);
  }

  get outputs(): AstraV3MintCallbackCall__Outputs {
    return new AstraV3MintCallbackCall__Outputs(this);
  }
}

export class AstraV3MintCallbackCall__Inputs {
  _call: AstraV3MintCallbackCall;

  constructor(call: AstraV3MintCallbackCall) {
    this._call = call;
  }
...
export class AstraV3MintCallbackCall__Outputs {
  _call: AstraV3MintCallbackCall;

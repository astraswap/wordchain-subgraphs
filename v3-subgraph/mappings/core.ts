...
export function handleSwap(event: SwapEvent): void {
  ...
  astraDayData.volumeETH = astraDayData.volumeETH.plus(volumeETH);
  astraDayData.volumeUSD = astraDayData.volumeUSD.plus(volumeUSD);
  astraDayData.feesUSD = astraDayData.feesUSD.plus(feesUSD);
  astraDayData.protocolFeesUSD = astraDayData.protocolFeesUSD.plus(protocolFeeAmounts.usd);

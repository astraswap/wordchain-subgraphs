...
export function updateAstraDayData(event: ethereum.Event): AstraDayData {
  let astra = Factory.load(FACTORY_ADDRESS);
  ...
  if (astraDayData === null) {
    ...
    astraDayData.volumeETH = ZERO_BD;
    astraDayData.volumeUSD = ZERO_BD;
    astraDayData.volumeUSDUntracked = ZERO_BD;
    astraDayData.feesUSD = ZERO_BD;
    astraDayData.protocolFeesUSD = ZERO_BD;
  }
  astraDayData.tvlUSD = astra.totalValueLockedUSD;
